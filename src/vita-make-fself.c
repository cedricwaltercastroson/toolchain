...
void usage(const char **argv) {
	fprintf(stderr, "usage: %s [-s|-ss|-a 0x2XXXXXXXXXXXXXXX] [-c] [-bp bootparam.bin] input.velf output-eboot.bin\n", argv[0] ? argv[0] : "dolce-make-fself");
	...
	fprintf(stderr, "\t-bp: Specify file to use as boot params.\n");
	exit(1);
}
